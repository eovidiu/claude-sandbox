/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7785a85a7caaa3dba2c9c3eb838e2f2c)
// Runtime types generated with workerd@1.20260811.1 2025-05-06 nodejs_compat
interface __BaseEnv_Env {
	MCP_SECRET_TOKEN: string;
	Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
	SandboxRegistry: DurableObjectNamespace<import("./src/index").SandboxRegistry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "SandboxRegistry";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MCP_SECRET_TOKEN">> {}
}
